# Flem ist eine kleine Firefox Toolbar von [Mathieu Bastian](https://github.com/mbastian), die lange URL-Listen verwaltet und das Navigieren von einer Webseite (Bild, Dokument, ...) zur anderen erlaubt.
